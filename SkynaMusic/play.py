...
async def play(c: Client, m: Message):
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                     photo=f"{IMG_5}",
                    caption="💬**Usage: /play Berikan Judul Lagu Untuk Memutar Musik atau bergabung @ilusi_kata**"
                    ,
